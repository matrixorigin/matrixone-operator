...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MatrixOneClusterRef) DeepCopyInto(out *MatrixOneClusterRef) {
	*out = *in
	if in.MatrixOne != nil {
		in, out := &in.MatrixOne, &out.MatrixOne
		*out = new(MatrixOneCluster)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MatrixOneClusterRef.
func (in *MatrixOneClusterRef) DeepCopy() *MatrixOneClusterRef {
	if in == nil {
		return nil
	}
	out := new(MatrixOneClusterRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WebUIDeps) DeepCopyInto(out *WebUIDeps) {
	*out = *in
	in.MatrixOneClusterRef.DeepCopyInto(&out.MatrixOneClusterRef)
}
