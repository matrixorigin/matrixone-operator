...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemProvider) DeepCopyInto(out *MemProvider) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemProvider.
func (in *MemProvider) DeepCopy() *MemProvider {
	if in == nil {
		return nil
	}
	out := new(MemProvider)
