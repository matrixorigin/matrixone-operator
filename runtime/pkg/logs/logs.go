...
func (m *Mlog) Info(msg string) {
	klog.Info(msg)
}

func (m *Mlog) V(level int) klog.Verbose {
	return klog.V(klog.Level(level))
}

func (m *Mlog) WithResource(l logr.Logger, obj metav1.Object, scheme *runtime.Scheme) logr.Logger {
