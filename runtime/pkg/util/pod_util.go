...
// originally copied from https://github.com/kubernetes/kubernetes/blob/master/pkg/api/v1/pod/util.go
// maintain these utilities is trivial while introduce kubernetes as a dependency is cumbersome
